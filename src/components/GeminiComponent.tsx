...
import { ImageIcon, Sparkle, Wrench } from "lucide-react";
import App from "./Ok3";
const GeminiImageAnalyzer = () => {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://84d5-2409-40c0-1018-603c-c526-93ce-7fde-d711.ngrok-free.app/sketch", formData, {
              ...
              <Card>
                ...
                <CardContent>
                  <pre className="bg-gray-100 p-4 rounded-lg overflow-auto max-h-[60vh]">
                    <code className="text-sm text-black">{generatedCode}</code>
                  </pre>
                </CardContent>
              </Card>
            </TabsContent>
